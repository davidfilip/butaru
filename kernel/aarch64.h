...
static inline uint64 r_vbar_el1() {
  uint64 x;
...
static inline void w_ttbr0_el1(uint64 x) {
...
static inline void w_ttbr1_el1(uint64 x) {
  asm volatile("msr ttbr1_el1, %0" : : "r" (x));
}

static inline uint64 r_ttbr1_el1() {
  uint64 x;
  asm volatile("mrs %0, ttbr1_el1" : "=r" (x) );
  return x;
}

static inline uint64 r_esr_el1() {
  uint64 x;
  asm volatile("mrs %0, esr_el1" : "=r" (x) );
  return x;
}

static inline void w_esr_el1(uint64 x) {
...
static inline uint64 r_far_el1() {
  uint64 x;
...
// armv8 generic timer
static inline uint64 r_cntv_ctl_el0() {
  uint64 x;
  asm volatile("mrs %0, cntv_ctl_el0" : "=r" (x) );
  return x;
}

static inline void w_cntv_ctl_el0(uint64 x) {
  asm volatile("msr cntv_ctl_el0, %0" : : "r" (x) );
}

static inline uint64 r_cntv_tval_el0() {
  uint64 x;
  asm volatile("mrs %0, cntv_tval_el0" : "=r" (x) );
  return x;
}

static inline void w_cntv_tval_el0(uint64 x) {
  asm volatile("msr cntv_tval_el0, %0" : : "r" (x) );
}

static inline uint64 r_cntvct_el0() {
  uint64 x;
